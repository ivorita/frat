...
import com.antelope.android.frat.data.DS;
import com.antelope.android.frat.data.IntegerData;
import com.antelope.android.frat.data.Picture;
import com.antelope.android.frat.net.APIService;
import com.antelope.android.frat.utils.DownloadUtils;
...
public class DataFragment extends Fragment implements OnRefreshListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mSrl.setColorSchemeColors(Color.parseColor("#2196F3"));
        getTemp();
        getHum();
        getDstate();
        fetchPic();
